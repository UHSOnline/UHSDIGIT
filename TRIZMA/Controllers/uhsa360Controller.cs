...
{
    public class uhsa360Controller : Controller
    {
        ...
        public ActionResult a360(int projectID, int taskOrderID, int Int1)
        {
            ...
            string agentName = db.agentsDbs.Where(s => s.userID == CurrentLoginID).Select(s => s.agentName).First();
                                                                                            ...
                                                                                            && returnTaskOrdersIDlist.Contains(55)))
            {
                ...
                if (userTypeid == 2)
                {
                    ...
                    var list4 = opa.UHSACCTSDbs.Where(s => list32.Contains(s.IDc) && s.typeid == 1).Select(s => new { IDc = s.IDc, CSTNM = s.CSTNM }).ToList();
                    ...
                    ViewBag.accts1 = opb.UHSWEBAVG01vDbs.Where(s => s.dctpid == 1010006).ToList();
                    ViewBag.accts2 = new SelectList(accts03, "IDc", "CSTNM").ToList();
                    ViewBag.accts3 = accts03.ToList();

                    if (yrchk == 1)
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID) && s.a360dyc == 1 && s.a360wkc == 1 && s.a360prc == 1 && s.a360qtc == 1 && s.a360yrc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID) && (s.a360dyc == 0 || s.a360wkc == 0 || s.a360prc == 0 || s.a360qtc == 0 || s.a360yrc == 0)).Count(); ViewBag.countBad = countBad;
                        ...
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list2.Contains(s.DISTID)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list2.Contains(s.DISTID)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list2.Contains(s.DISTID)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list2.Contains(s.DISTID)).Count();
                        int acng3 = opb.UHSWEBOMD11vDbs.Where(s => s.a360prc == 1 && list2.Contains(s.DISTID)).Count(); int acnb3 = opb.UHSWEBOMD11vDbs.Where(s => s.a360prc == 0 && list2.Contains(s.DISTID)).Count();
                        int acng4 = opb.UHSWEBOMD11vDbs.Where(s => s.a360qtc == 1 && list2.Contains(s.DISTID)).Count(); int acnb4 = opb.UHSWEBOMD11vDbs.Where(s => s.a360qtc == 0 && list2.Contains(s.DISTID)).Count();
                        int acng5 = opb.UHSWEBOMD11vDbs.Where(s => s.a360yrc == 1 && list2.Contains(s.DISTID)).Count(); int acnb5 = opb.UHSWEBOMD11vDbs.Where(s => s.a360yrc == 0 && list2.Contains(s.DISTID)).Count();


                        var as01 = opb.UHSWEBAABvDbs.Where(s => list2.Contains(s.ID)).Select(s => s.AAS01).Average(); var aas01 = string.Format("{0:n2}", ((float)(int)as01 / (float)(int)40) * 100); var ad01 = string.Format("{0:n2}", as01);

                        List<uhspageitemsDb> pageModel2 = new List<uhspageitemsDb>();
                        uhspageitemsDb List1 = new uhspageitemsDb();

                        List1.modInt01 = acng1;
                        List1.modInt02 = acng2;
                        List1.modInt03 = acng3;
                        List1.modInt04 = acng4;
                        List1.modInt05 = acng5;
                        List1.modInt06 = acnb1;
                        List1.modInt07 = acnb2;
                        List1.modInt08 = acnb3;
                        List1.modInt09 = acnb4;
                        List1.modInt10 = acnb5;

                        pageModel2.Add(List1);
                    ...
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID) && s.a360dyc == 1 && s.a360wkc == 1 && s.a360prc == 1 && s.a360qtc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID) && (s.a360dyc == 0 || s.a360wkc == 0 || s.a360prc == 0 || s.a360qtc == 0)).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list2.Contains(s.DISTID)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list2.Contains(s.DISTID)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list2.Contains(s.DISTID)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list2.Contains(s.DISTID)).Count();
                    ...
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID) && s.a360dyc == 1 && s.a360prc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID) && (s.a360dyc == 0 || s.a360prc == 0)).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list2.Contains(s.DISTID)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list2.Contains(s.DISTID)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list2.Contains(s.DISTID)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list2.Contains(s.DISTID)).Count();
                    ...
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID) && s.a360dyc == 1 && s.a360wkc == 1 && s.a360prc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID) && (s.a360dyc == 0 || s.a360wkc == 0 || s.a360prc == 0)).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list2.Contains(s.DISTID)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list2.Contains(s.DISTID)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list2.Contains(s.DISTID)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list2.Contains(s.DISTID)).Count();
                    ...
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID) && s.a360dyc == 1 && s.a360wkc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID) && (s.a360dyc == 0 || s.a360wkc == 0)).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list2.Contains(s.DISTID)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list2.Contains(s.DISTID)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list2.Contains(s.DISTID)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list2.Contains(s.DISTID)).Count();
                    ...
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID) && s.a360dyc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID) && s.a360dyc == 0).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list2.Contains(s.DISTID)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list2.Contains(s.DISTID)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list2.Contains(s.DISTID)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list2.Contains(s.DISTID)).Count();
                    ...
                    if (dych1 == 6 || dych1 == 7)
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID) && s.wchk == 1).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID) && s.wchk == 1 && s.a360dyc == 1 && s.a360wkc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list2.Contains(s.DISTID) && s.wchk == 1 && (s.a360dyc == 0 || s.a360wkc == 0)).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list2.Contains(s.DISTID)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list2.Contains(s.DISTID)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list2.Contains(s.DISTID)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list2.Contains(s.DISTID)).Count();
                ...
                else if (usertitle == 1)
                {
                    ...
                    List<int> list1 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 1 && s.divID == itn2).Select(s => s.ID).ToList());
                    List<int> list2 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 1 && list1.Contains(s.ID)).Select(s => s.divID).Distinct().ToList());
                    List<int> list3 = new List<int>(opa.UHSACCTSDbs.Where(s => s.typeid == 1 && list1.Contains(s.DISTID)).Select(s => s.IDc).ToList());
                    ...
                    ViewBag.accts1 = opb.UHSWEBAVG01vDbs.Where(s => s.dctpid == 1010006 && list3.Contains(s.acctid)).ToList();
                    ViewBag.headdef1 = opb.dimDivisionDbs.Where(s => s.ID == itn2).Select(s => s.DivisionName).First();
                    ViewBag.headdef2 = "Division Level";
                    var dtop = DateTime.Now;
                    DateTime pastmnt = dtop.AddMonths(-1);
                    DateTime l2wek = dtop.AddDays(-7);
                    var l2wes = l2wek.ToString("yyyyMMdd");
                    var l2week = int.Parse(l2wes);
                    List<int> list01 = new List<int>(db.agentsDbs.Where(s => s.DODID == userid && s.ID != userid).Select(s => s.distid).Distinct().ToList());

                    var itemdt = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 1 && list01.Contains(s.distid) && s.yyyymmdd >= l2week)
                    ...
                    List<UHSOMD11vDb> data01 = new List<UHSOMD11vDb>();
                    ...
                    ViewBag.data1 = data01;

                    if (yrchk == 1)
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID) && s.a360dyc == 1 && s.a360wkc == 1 && s.a360prc == 1 && s.a360qtc == 1 && s.a360yrc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID) && (s.a360dyc == 0 || s.a360wkc == 0 || s.a360prc == 0 || s.a360qtc == 0 || s.a360yrc == 0)).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list1.Contains(s.DISTID)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list1.Contains(s.DISTID)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list1.Contains(s.DISTID)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list1.Contains(s.DISTID)).Count();
                        int acng3 = opb.UHSWEBOMD11vDbs.Where(s => s.a360prc == 1 && list1.Contains(s.DISTID)).Count(); int acnb3 = opb.UHSWEBOMD11vDbs.Where(s => s.a360prc == 0 && list1.Contains(s.DISTID)).Count();
                        int acng4 = opb.UHSWEBOMD11vDbs.Where(s => s.a360qtc == 1 && list1.Contains(s.DISTID)).Count(); int acnb4 = opb.UHSWEBOMD11vDbs.Where(s => s.a360qtc == 0 && list1.Contains(s.DISTID)).Count();
                        int acng5 = opb.UHSWEBOMD11vDbs.Where(s => s.a360yrc == 1 && list1.Contains(s.DISTID)).Count(); int acnb5 = opb.UHSWEBOMD11vDbs.Where(s => s.a360yrc == 0 && list1.Contains(s.DISTID)).Count();

                        var as01 = opb.UHSWEBAABvDbs.Where(s => list1.Contains(s.ID)).Select(s => s.AAS01).Average(); var aas01 = string.Format("{0:n2}", ((float)(int)as01 / (float)(int)40) * 100); var ad01 = string.Format("{0:n2}", as01);
                    ...
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID) && s.a360dyc == 1 && s.a360wkc == 1 && s.a360prc == 1 && s.a360qtc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID) && (s.a360dyc == 0 || s.a360wkc == 0 || s.a360prc == 0 || s.a360qtc == 0)).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list1.Contains(s.DISTID)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list1.Contains(s.DISTID)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list1.Contains(s.DISTID)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list1.Contains(s.DISTID)).Count();
                    ...
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID) && s.a360dyc == 1 && s.a360prc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID) && (s.a360dyc == 0 || s.a360prc == 0)).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list1.Contains(s.DISTID)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list1.Contains(s.DISTID)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list1.Contains(s.DISTID)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list1.Contains(s.DISTID)).Count();
                    ...
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID) && s.a360dyc == 1 && s.a360wkc == 1 && s.a360prc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID) && (s.a360dyc == 0 || s.a360wkc == 0 || s.a360prc == 0)).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list1.Contains(s.DISTID)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list1.Contains(s.DISTID)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list1.Contains(s.DISTID)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list1.Contains(s.DISTID)).Count();
                    ...
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID) && s.a360dyc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID) && s.a360dyc == 0).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list1.Contains(s.DISTID)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list1.Contains(s.DISTID)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list1.Contains(s.DISTID)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list1.Contains(s.DISTID)).Count();
                    ...
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID) && s.a360dyc == 1 && s.a360wkc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID) && (s.a360dyc == 0 || s.a360wkc == 0)).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list1.Contains(s.DISTID)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list1.Contains(s.DISTID)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list1.Contains(s.DISTID)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list1.Contains(s.DISTID)).Count();
                    ...
                    if (dych1 == 6 || dych1 == 7)
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID) && s.wchk == 1).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID) && s.wchk == 1 && s.a360dyc == 1 && s.a360wkc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID) && s.wchk == 1 && (s.a360dyc == 0 || s.a360wkc == 0)).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list1.Contains(s.DISTID)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list1.Contains(s.DISTID)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list1.Contains(s.DISTID)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list1.Contains(s.DISTID)).Count();
                ...
                else if (usertitle == 2 || usertitle == 3)
                {
                    ...
                    ViewBag.division = new SelectList(opb.dimDivisionDbs.Where(s => s.ID == 0 || list2.Contains(s.ID)).OrderBy(s => s.DivisionName), "ID", "DivisionName").ToList();
                    ViewBag.accts1 = opb.UHSWEBAVG01vDbs.Where(s => s.dctpid == 1010006 && list4.Contains(s.acctid)).ToList();
                    ...
                    if (yrchk == 1)
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc) && s.a360dyc == 1 && s.a360wkc == 1 && s.a360prc == 1 && s.a360qtc == 1 && s.a360yrc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc) && (s.a360dyc == 0 || s.a360wkc == 0 || s.a360prc == 0 || s.a360qtc == 0 || s.a360yrc == 0)).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list4.Contains(s.IDc)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list4.Contains(s.IDc)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list4.Contains(s.IDc)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list4.Contains(s.IDc)).Count();
                        int acng3 = opb.UHSWEBOMD11vDbs.Where(s => s.a360prc == 1 && list4.Contains(s.IDc)).Count(); int acnb3 = opb.UHSWEBOMD11vDbs.Where(s => s.a360prc == 0 && list4.Contains(s.IDc)).Count();
                        int acng4 = opb.UHSWEBOMD11vDbs.Where(s => s.a360qtc == 1 && list4.Contains(s.IDc)).Count(); int acnb4 = opb.UHSWEBOMD11vDbs.Where(s => s.a360qtc == 0 && list4.Contains(s.IDc)).Count();
                        int acng5 = opb.UHSWEBOMD11vDbs.Where(s => s.a360yrc == 1 && list4.Contains(s.IDc)).Count(); int acnb5 = opb.UHSWEBOMD11vDbs.Where(s => s.a360yrc == 0 && list4.Contains(s.IDc)).Count();
                    ...
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc) && s.a360dyc == 1 && s.a360wkc == 1 && s.a360prc == 1 && s.a360qtc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc) && (s.a360dyc == 0 || s.a360wkc == 0 || s.a360prc == 0 || s.a360qtc == 0)).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list4.Contains(s.IDc)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list4.Contains(s.IDc)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list4.Contains(s.IDc)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list4.Contains(s.IDc)).Count();
                    ...
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc) && s.a360dyc == 1 && s.a360prc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc) && (s.a360dyc == 0 || s.a360prc == 0)).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list4.Contains(s.IDc)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list4.Contains(s.IDc)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list4.Contains(s.IDc)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list4.Contains(s.IDc)).Count();
                    ...
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc) && s.a360dyc == 1 && s.a360wkc == 1 && s.a360prc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc) && (s.a360dyc == 0 || s.a360wkc == 0 || s.a360prc == 0)).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list4.Contains(s.IDc)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list4.Contains(s.IDc)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list4.Contains(s.IDc)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list4.Contains(s.IDc)).Count();
                    ...
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc) && s.a360dyc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc) && s.a360dyc == 0).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list4.Contains(s.IDc)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list4.Contains(s.IDc)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list4.Contains(s.IDc)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list4.Contains(s.IDc)).Count();
                    ...
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc) && s.a360dyc == 1 && s.a360wkc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc) && (s.a360dyc == 0 || s.a360wkc == 0)).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list4.Contains(s.IDc)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list4.Contains(s.IDc)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list4.Contains(s.IDc)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list4.Contains(s.IDc)).Count();
                    ...
                    if (dych1 == 6 || dych1 == 7)
                    {
                        int countTotal = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc) && s.wchk == 1).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc) && s.wchk == 1 && s.a360dyc == 1 && s.a360wkc == 1).Count(); ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc) && s.wchk == 1 && (s.a360dyc == 0 || s.a360wkc == 0)).Count(); ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list4.Contains(s.IDc)).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list4.Contains(s.IDc)).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list4.Contains(s.IDc)).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list4.Contains(s.IDc)).Count();
                ...
                else
                {
                    ...
                    if (dych1 == 6 || dych1 == 7)
                    {
                        ...
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int acng1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 1 && list2.Contains(s.DISTID) && s.wchk == 1).Count(); int acnb1 = opb.UHSWEBOMD11vDbs.Where(s => s.a360dyc == 0 && list2.Contains(s.DISTID) && s.wchk == 1).Count();
                        int acng2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 1 && list2.Contains(s.DISTID) && s.wchk == 1).Count(); int acnb2 = opb.UHSWEBOMD11vDbs.Where(s => s.a360wkc == 0 && list2.Contains(s.DISTID) && s.wchk == 1).Count();
                        int acng3 = opb.UHSWEBOMD11vDbs.Where(s => s.a360prc == 1 && list2.Contains(s.DISTID) && s.wchk == 1).Count(); int acnb3 = opb.UHSWEBOMD11vDbs.Where(s => s.a360prc == 0 && list2.Contains(s.DISTID) && s.wchk == 1).Count();
                        int acng4 = opb.UHSWEBOMD11vDbs.Where(s => s.a360qtc == 1 && list2.Contains(s.DISTID) && s.wchk == 1).Count(); int acnb4 = opb.UHSWEBOMD11vDbs.Where(s => s.a360qtc == 0 && list2.Contains(s.DISTID) && s.wchk == 1).Count();
                        int acng5 = opb.UHSWEBOMD11vDbs.Where(s => s.a360yrc == 1 && list2.Contains(s.DISTID) && s.wchk == 1).Count(); int acnb5 = opb.UHSWEBOMD11vDbs.Where(s => s.a360yrc == 0 && list2.Contains(s.DISTID) && s.wchk == 1).Count();
        ...
        public ActionResult _bck10100067()
        {
                                                                                ...
                                                                                && returnTaskOrdersIDlist.Contains(55)))
            {
                ...
                if (userTypeid == 2)
                {
                    List<int> list1 = new List<int>(opa.UHSACCTSDbs.Where(s => s.typeid == 1).Select(s => s.IDc).Distinct());
                    var itemdt = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 1 && list1.Contains(s.acctid) && s.yyyymmdd >= l2week)
                                                 .Select(s => new { ID = s.ID, crdate = s.crdate, yyyymm = s.yyyymm, weeknr = s.weeknr, dctpid = s.dctpid, distid = s.distid, distnm = s.distnm, acctid = s.acctid, CSTNM = s.CSTNM });
                    ...
                    return PartialView("_bck10100067", data.ToList());
                ...
                else if (usertitle == 1)
                {
                    ...
                    var itemdt = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 1 && list1.Contains(s.distid) && s.yyyymmdd >= l2week)
                                                .Select(s => new { ID = s.ID, crdate = s.crdate, yyyymm = s.yyyymm, weeknr = s.weeknr, dctpid = s.dctpid, distid = s.distid, distnm = s.distnm, acctid = s.acctid, CSTNM = s.CSTNM });
                    List<UHSOMD11vDb> data = new List<UHSOMD11vDb>();
                    foreach (var item in itemdt)
                    {
                ...
                else if (usertitle == 2 || usertitle == 3)
                {
                    ...
                    var itemdt = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 1 && list4.Contains(s.acctid) && s.yyyymmdd >= l2week)
                                                .Select(s => new { ID = s.ID, crdate = s.crdate, yyyymm = s.yyyymm, weeknr = s.weeknr, dctpid = s.dctpid, distid = s.distid, distnm = s.distnm, acctid = s.acctid, CSTNM = s.CSTNM });
                    List<UHSOMD11vDb> data = new List<UHSOMD11vDb>();
                    foreach (var item in itemdt)
                    {
            ...
            return PartialView("_bck10100067");
        }

        public ActionResult getEditPar10100067(int dctp, int id1, int id2, string id3)
        {
            ...
            int cnt1 = opb.UHSUSAC1A360Dbs.Where(s => s.MGRID == userid && s.IDc == id1).Count();
                                                                                ...
                                                                                && cnt1 >= 1))
            {
                ...
                var dtus1 = opa.DATAOPATIME_FRAMEDbs.Where(s => s.dateYMD == dti).Select(s => s.dateus).First();
                ...
                if (id2 == 1)
                {
                    ...
                    var wchk1 = opa.UHSACCTSDbs.Where(s => s.IDc == id1 && s.typeid == 1).Select(s => s.wchk).First();
                    ...
                    if (wchk1 == 1)
                    {
                        ...
                        lista1.modStr4 = opa.DATAOPATIME_FRAMEDbs.Where(s => s.YYYY == yer1 && s.daywnm != 6 && s.daywnm != 7).OrderByDescending(s => s.dateYMD).Select(s => s.dateus).First();
                        Data1.Add(lista1);
                    }
                    else
                    if (wchk1 == 2)
                    ...
                    List<UHSOMD11vDb> UHSOMD11vDbA = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 1 && s.acctid == id1 && s.crdate == dts).ToList();
                    var a11 = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 1 && s.acctid == id1 && s.crdate == dts).Select(s => s.ID).First();
                    ...
                    List<UHSOMD11vDb> UHSOMD11vDbB = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 2 && s.acctid == id1 && s.yyyymm == per1 && s.weeknr == wek1).ToList();
                    var a12 = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 2 && s.acctid == id1 && s.yyyymm == per1 && s.weeknr == wek1).Select(s => s.ID).First();
                    ...
                    List<UHSOMD11vDb> UHSOMD11vDbC = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 3 && s.acctid == id1 && s.yyyymm == per2).ToList();
                    var a13 = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 3 && s.acctid == id1 && s.yyyymm == per2).Select(s => s.ID).First();
                    ...
                    List<UHSOMD11vDb> UHSOMD11vDbD = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 4 && s.acctid == id1 && qtrdates.Contains(s.crdate)).ToList();
                    var a14 = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 4 && s.acctid == id1 && qtrdates.Contains(s.crdate)).Select(s => s.ID).First();
                    ...
                    List<UHSOMD11vDb> UHSOMD11vDbE = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 5 && s.acctid == id1 && s.yyyy == yer1).ToList();
                    var a15 = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 5 && s.acctid == id1 && s.yyyy == yer1).Select(s => s.ID).First();
                    List<UHSOMD15Db> UHSOMD15Db = opa.UHSOMD15Dbs.Where(s => s.ID == a15).ToList();

                    yrPar.modInt01 = opb.UHSOMD11vDbs.Where(s => s.ID == a15).Select(s => s.yyyymmdd).First();
                    yrPar.modInt02 = opb.UHSOMD11vDbs.Where(s => s.ID == a15).Select(s => s.weeknr).First();
                    yrPar.modInt03 = opb.UHSOMD11vDbs.Where(s => s.ID == a15).Select(s => s.yyyymm).First();
                    yrPar.modInt04 = opb.UHSOMD11vDbs.Where(s => s.ID == a15).Select(s => s.distid).First();
                    yrPar.modInt05 = opb.UHSOMD11vDbs.Where(s => s.ID == a15).Select(s => s.acctid).First();
                    yrPar.modInt06 = opb.UHSOMD11vDbs.Where(s => s.ID == a15).Select(s => s.dcgrid).First();
                    yrPar.modInt07 = opb.UHSOMD11vDbs.Where(s => s.ID == a15).Select(s => s.dctpid).First();
                    yrPar.modStr1 = a15;
                    constrID.Add(yrPar);

                    foreach (var i in fileArray)
                    {
                        uhspageitemsDb ListR = new uhspageitemsDb();
                        var itt1 = i.ToString();
                    ...
                    ViewBag.dnltbdata = dataSet1.Where(s => s.modStr1.Contains(a11)).ToList();
                    ...
                    List1.zacc = opa.UHSACCTSDbs.Where(s => s.IDc == id1 && s.typeid == 1).Select(s => s.CSTNM).First();
                    List1.zdiv = opa.UHSACCTSDbs.Where(s => s.IDc == id1 && s.typeid == 1).Select(s => s.DIV).First();
                    List1.zomh = opa.UHSACCTSDbs.Where(s => s.IDc == id1 && s.typeid == 1).Select(s => s.MGR).First();
                    List1.zdod = opa.UHSACCTSDbs.Where(s => s.IDc == id1 && s.typeid == 1).Select(s => s.DOD).First();
                    List1.zdis = opa.UHSACCTSDbs.Where(s => s.IDc == id1 && s.typeid == 1).Select(s => s.DIST).First();
                    ...
                    List1.dtDue5 = Data1.Select(s => s.modStr4).First();
                ...
                else if (id2 == 2)
                {
                    ...
                    var dat01 = opb.UHSOMD11vDbs.Where(s => s.ID == id3).Select(s => s.crdate).First();
                    var date41 = opa.DATAOPATIME_FRAMEDbs.Where(s => s.dateID == dat01).Select(s => s.dateus).First();
                    ...
                    var mnth02 = opa.DATAOPATIME_FRAMEDbs.Where(s => s.dateID == dat01).Select(s => s.YYYYMM).First();
                    var qotr01 = opa.DATAOPATIME_FRAMEDbs.Where(s => s.dateID == dat01).Select(s => s.Quarter).First();
                    var year01 = opa.DATAOPATIME_FRAMEDbs.Where(s => s.dateID == dat01).Select(s => s.YYYY).First();

                    if (dat01 == dts) { ViewBag.qday = 1; } else { ViewBag.qday = 0; }
                    ...
                    var itemq = opa.DATAOPATIME_FRAMEDbs.Where(s => s.dateID == dat01).Select(s => s.Quarter).First();
                    ...
                    List<UHSOMD11vDb> UHSOMD11vDbB = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 2 && s.acctid == id1 && s.yyyy == year01 && s.weeknr == week01).ToList();
                    var a12 = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 2 && s.acctid == id1 && s.yyyy == year01 && s.weeknr == week01).Select(s => s.ID).First();
                    List<UHSOMD12Db> UHSOMD12Db = opa.UHSOMD12Dbs.Where(s => s.ID == a12).ToList();
                    ...
                    List<UHSOMD11vDb> UHSOMD11vDbC = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 3 && s.acctid == id1 && s.yyyymm == mnth02).ToList();
                    var a13 = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 3 && s.acctid == id1 && s.yyyymm == mnth02).Select(s => s.ID).First();
                    List<UHSOMD13Db> UHSOMD13Db = opa.UHSOMD13Dbs.Where(s => s.ID == a13).ToList();
                    ...
                    List<UHSOMD11vDb> UHSOMD11vDbD = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 4 && s.acctid == id1 && qutr01.Contains(s.crdate)).ToList();
                    var a14 = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 4 && s.acctid == id1 && qutr01.Contains(s.crdate)).Select(s => s.ID).First();
                    List<UHSOMD14Db> UHSOMD14Db = opa.UHSOMD14Dbs.Where(s => s.ID == a14).ToList();
                    ...
                    List<UHSOMD11vDb> UHSOMD11vDbE = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 5 && s.acctid == id1 && s.yyyy == year01).ToList();
                    var a15 = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010006 && s.tspdid == 5 && s.acctid == id1 && s.yyyy == year01).Select(s => s.ID).First();
                    List<UHSOMD15Db> UHSOMD15Db = opa.UHSOMD15Dbs.Where(s => s.ID == a15).ToList();

                    qtPar.modInt01 = opb.UHSOMD11vDbs.Where(s => s.ID == a15).Select(s => s.yyyymmdd).First();
                    qtPar.modInt02 = opb.UHSOMD11vDbs.Where(s => s.ID == a15).Select(s => s.weeknr).First();
                    qtPar.modInt03 = opb.UHSOMD11vDbs.Where(s => s.ID == a15).Select(s => s.yyyymm).First();
                    qtPar.modInt04 = opb.UHSOMD11vDbs.Where(s => s.ID == a15).Select(s => s.distid).First();
                    qtPar.modInt05 = opb.UHSOMD11vDbs.Where(s => s.ID == a15).Select(s => s.acctid).First();
                    qtPar.modInt06 = opb.UHSOMD11vDbs.Where(s => s.ID == a15).Select(s => s.dcgrid).First();
                    qtPar.modInt07 = opb.UHSOMD11vDbs.Where(s => s.ID == a15).Select(s => s.dctpid).First();
                    qtPar.modStr1 = a15;
                    constrID.Add(qtPar);
                    ...
                    ViewBag.dnltbdata = dataSet1.Where(s => s.modStr1.Contains(id3)).ToList();
        ...
        public ActionResult _geta360data(int IDa, int IDb)
        {
            string CurrentLoginID = User.Identity.GetUserId().ToString();
            ...
            if (IDa == 0 && IDb == 0)
            {
                if (userTypeid == 2)
                {
                    var datatable = opb.UHSWEBOMD11vDbs.OrderBy(s => s.IDc).ToList();

                    return PartialView("_geta360data", datatable);
                }
                else if (usertitle == 1)
                {
                    int itn1 = db.agentsDbs.Where(s => s.ID == userid).Select(s => s.divid).First();
                    var list1 = opa.DISTRICTSDbs.Where(s => s.compid == 1 && s.divID == itn1).Select(s => s.ID).Distinct().ToList();
                    var datatable = opb.UHSWEBOMD11vDbs.Where(s => list1.Contains(s.DISTID)).OrderBy(s => s.IDc).ToList();
                    return PartialView("_geta360data", datatable);
                }
                else if (usertitle == 2 || usertitle == 3)
                {
                    //var list1 = db.agentsDbs.Where(s => s.ID == userid).Select(s => s.distid).Distinct().ToList();
                    var list4 = opb.UHSUSAC1A360Dbs.Where(s => s.MGRID == userid).Select(s => s.IDc).ToList();
                    var datatable = opb.UHSWEBOMD11vDbs.Where(s => list4.Contains(s.IDc)).OrderBy(s => s.IDc).ToList();
                    return PartialView("_geta360data", datatable);
                }
                else
                {
        ...
        public ActionResult geta360dist(int ID)
        {
            List<int> list1 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 1 && s.divID == ID).Select(s => s.ID).Distinct());
            List<int> list2 = new List<int>(opa.UHSACCTSDbs.Where(s => s.typeid == 1).Select(s => s.DISTID).Distinct());
        ...
        public ActionResult geta360acdv(int ID)
        {
            ...
            var item1 = opa.UHSACCTSDbs.Where(s => s.typeid == 1 && it01.Contains(s.DISTID)).Select(s => new { IDc = s.IDc, CSTNM = s.CSTNM }).ToList();
            foreach (var item in item1)
            {
        ...
        public ActionResult geta360acct(int ID)
        {
            List<UHSACCTSDb> UHSACCTSDb = new List<UHSACCTSDb>();
            ...
            var item1 = opa.UHSACCTSDbs.Where(s => s.typeid == 1 && (s.IDc == 0 || s.DISTID == ID)).Select(s => new { IDc = s.IDc, CSTNM = s.CSTNM }).ToList();
            foreach (var item in item1)
            {
                UHSACCTSDb list12 = new UHSACCTSDb();
                list12.IDc = item.IDc;
