...
{
    public class k2017orgStrL3Controller : Controller
    {
        ...
        public ActionResult Create()
        {
                                                                                            ...
                                                                                            && returnTaskOrdersIDlist.Contains(41)))
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("prock2017orgStrL3IDres", con);
        ...
        // POST: k2017orgStrL3Dbs/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "ID, projectID, taskOrderID, orgStrL1ID, orgStrL2ID, orgStrL3, createdDT, editedDT, createdByUserID")] k2017orgStrL3Db k2017orgStrL3Db)
        {
            string CurrentLoginID = User.Identity.GetUserId().ToString();
                                                                                            ...
                                                                                            && returnTaskOrdersIDlist.Contains(41)))
            {
                ...
                {
                    db.k2017orgStrL3Dbs.Add(k2017orgStrL3Db);
                    db.SaveChanges();
                    return RedirectToAction("Index", "k2017orgAdmStructure", new { projectID = 10, taskOrderID = 41, Int1 = 1 });
                }

                return View(k2017orgStrL3Db);
            }
            else
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        public ActionResult Edit(int? id)
        {
            ...
            k2017orgStrL3Db k2017orgStrL3Db = db.k2017orgStrL3Dbs.Find(id);

            if (k2017orgStrL3Db == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            }
                                                                                            ...
                                                                                            && returnTaskOrdersIDlist.Contains(41)))
            {
                ...
                var It02 = db.k2017orgStrL3Dbs.Where(s => s.ID == id)
                ...
                var Item32 = from m in db.k2017orgStrL3Dbs where m.ID == id select m.createdByUserID;
        ...
        // POST: k2017orgStrL3Dbs/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID, projectID, taskOrderID, orgStrL1ID, orgStrL2ID, orgStrL3, createdDT, editedDT, createdByUserID")] k2017orgStrL3Db k2017orgStrL3Db)
        {
            string CurrentLoginID = User.Identity.GetUserId().ToString();
                                                                                            ...
                                                                                            && returnTaskOrdersIDlist.Contains(41)))
            {
                ...
                if (ModelState.IsValid)
                {
                    db.Entry(k2017orgStrL3Db).State = EntityState.Modified;
                    db.SaveChanges();
                    return RedirectToAction("Index", "k2017orgAdmStructure", new { projectID = 10, taskOrderID = 41, Int1 = 1 });
                }
                return View(k2017orgStrL3Db);
        ...
        // POST: k2017orgStrL3Dbs/Delete/5
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            {
                k2017orgStrL3Db k2017orgStrL3Db = db.k2017orgStrL3Dbs.Find(id);
                db.k2017orgStrL3Dbs.Remove(k2017orgStrL3Db);
                db.SaveChanges();
                return RedirectToAction("Index", "k2017orgAdmStructure", new { projectID = 10, taskOrderID = 41, Int1 = 1 });
            }
            {
        ...
        public ActionResult ExportToExcel()
        {
            ...
            var ExportList = from p in dbv.k2017orgStrL3ViewDbs
            ...
            Response.AddHeader("content-disposition", "attachment; filename=Export_TRIZMA_ORGADM_OrgStructure_Leve3.xls");
