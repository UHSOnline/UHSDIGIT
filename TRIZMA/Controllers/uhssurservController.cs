...
{
    public class uhssurservController : Controller
    {
        ...
        public ActionResult sscadence(int projectID, int taskOrderID, int Int1)
        {
            ...
            ViewBag.eChart1010009 = opb.UHSWEBAVG01vDbs.Where(s => s.dctpid == 1010009).ToList();
                                                                                            ...
                                                                                            && returnTaskOrdersIDlist.Contains(57)))
            {
                ...
                if (userTypeid == 2)
                {
                    ...
                    if (dych1 == 7)
                    {
                        ...
                        List<int> list1 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 2 && s.wchk == 3).Select(s => s.divID).Distinct());
                        ...
                        if (dt1 == chk4)
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID)).Count(); ViewBag.countTotal = countTotal;
                            int countGood = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID) && s.omdch1 == 1 && s.omdch2 == 1 && s.omdch3 == 1 && s.omdch4 == 1).Count(); ViewBag.countGood = countGood;
                            int countBad = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0 || s.omdch4 == 0)).Count(); ViewBag.countBad = countBad;
                            ...
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omd0 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 0 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omw1 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 1 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omw0 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 0 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omm1 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 1 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omm0 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 0 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omq1 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 1 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omq0 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 0 && list1.Contains(s.divID) && s.wchk == 3).Count();
                            List<uhspageitemsDb> pageModel = new List<uhspageitemsDb>(); uhspageitemsDb List1 = new uhspageitemsDb();

                            List1.modInt01 = omd1; List1.modInt02 = omd0; List1.modInt03 = omw1; List1.modInt04 = omw0; List1.modInt05 = omm1; List1.modInt06 = omm0; List1.modInt07 = omq1; List1.modInt08 = omq0;
                            pageModel.Add(List1);
                        ...
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID)).Count(); ViewBag.countTotal = countTotal;
                            int countGood = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID) && s.omdch1 == 1 && s.omdch2 == 1 && s.omdch3 == 1).Count(); ViewBag.countGood = countGood;
                            int countBad = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0)).Count(); ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omd0 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 0 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omw1 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 1 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omw0 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 0 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omm1 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 1 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omm0 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 0 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omq1 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 1 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omq0 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 0 && list1.Contains(s.divID) && s.wchk == 3).Count();
                            List<uhspageitemsDb> pageModel = new List<uhspageitemsDb>(); uhspageitemsDb List1 = new uhspageitemsDb();
                        ...
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID)).Count(); ViewBag.countTotal = countTotal;
                            int countGood = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID) && s.omdch1 == 1 && s.omdch2 == 1).Count(); ViewBag.countGood = countGood;
                            int countBad = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID) && (s.omdch1 == 0 || s.omdch2 == 0)).Count(); ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omd0 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 0 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omw1 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 1 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omw0 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 0 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omm1 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 1 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omm0 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 0 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omq1 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 1 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omq0 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 0 && list1.Contains(s.divID) && s.wchk == 3).Count();
                            List<uhspageitemsDb> pageModel = new List<uhspageitemsDb>(); uhspageitemsDb List1 = new uhspageitemsDb();
                        ...
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID)).Count(); ViewBag.countTotal = countTotal;
                            int countGood = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID) && s.omdch1 == 1).Count(); ViewBag.countGood = countGood;
                            int countBad = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID) && s.omdch1 == 0).Count(); ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omd0 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 0 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omw1 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 1 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omw0 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 0 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omm1 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 1 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omm0 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 0 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omq1 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 1 && list1.Contains(s.divID) && s.wchk == 3).Count(); int omq0 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 0 && list1.Contains(s.divID) && s.wchk == 3).Count();
                            List<uhspageitemsDb> pageModel = new List<uhspageitemsDb>(); uhspageitemsDb List1 = new uhspageitemsDb();
                    ...
                    if (dych1 == 6)
                    {
                        ...
                        List<int> list1 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 2 && (s.wchk == 2 || s.wchk == 3)).Select(s => s.divID).Distinct());
                        ViewBag.division = new SelectList(opb.dimDivisionDbs.Where(s => s.ID == 0 || list1.Contains(s.ID)).OrderBy(s => s.DivisionName), "ID", "DivisionName").ToList();

                        if (dt1 == chk4 && chk4b > chk4)
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID)).Count(); ViewBag.countTotal = countTotal; int cnt101 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 2 && list1.Contains(s.divID) && s.omdch1 == 1 && s.omdch2 == 1 && s.omdch3 == 1 && s.omdch4 == 1).Count(); int cnt102 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 3 && list1.Contains(s.divID) && s.omdch1 == 1).Count(); int countGood = cnt101 + cnt102; ViewBag.countGood = countGood; int cnt201 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 2 && list1.Contains(s.divID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0 || s.omdch4 == 0)).Count(); int cnt202 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 3 && list1.Contains(s.divID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0)).Count(); int countBad = cnt201 + cnt202; ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count(); int omd0 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 0 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count(); int omw1 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 1 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count(); int omw0 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 0 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count(); int omm1 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 1 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count(); int omm0 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 0 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count(); int omq1 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 1 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count(); int omq0 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 0 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count();
                            List<uhspageitemsDb> pageModel = new List<uhspageitemsDb>(); uhspageitemsDb List1 = new uhspageitemsDb();
                            List1.modInt01 = omd1; List1.modInt02 = omd0; List1.modInt03 = omw1; List1.modInt04 = omw0; List1.modInt05 = omm1; List1.modInt06 = omm0; List1.modInt07 = omq1; List1.modInt08 = omq0;
                            pageModel.Add(List1);
                        ...
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID)).Count(); ViewBag.countTotal = countTotal;
                            int countGood = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && list1.Contains(s.divID) && s.omdch1 == 1 && s.omdch2 == 1 && s.omdch3 == 1 && s.omdch4 == 1).Count();
                            ViewBag.countGood = countGood;
                            int countBad = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && list1.Contains(s.divID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0 || s.omdch4 == 0)).Count(); ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count(); int omd0 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 0 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count(); int omw1 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 1 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count(); int omw0 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 0 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count(); int omm1 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 1 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count(); int omm0 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 0 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count(); int omq1 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 1 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count(); int omq0 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 0 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count();
                            List<uhspageitemsDb> pageModel = new List<uhspageitemsDb>(); uhspageitemsDb List1 = new uhspageitemsDb();
                        ...
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID)).Count(); ViewBag.countTotal = countTotal;
                            int cnt101 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 2 && list1.Contains(s.divID) && s.omdch1 == 1 && s.omdch2 == 1 && s.omdch3 == 1).Count();
                            int cnt102 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 3 && list1.Contains(s.divID) && s.omdch1 == 1).Count();
                            int countGood = cnt101 + cnt102; ViewBag.countGood = countGood;
                            int cnt201 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 2 && list1.Contains(s.divID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0)).Count();
                            int cnt202 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 3 && list1.Contains(s.divID) && s.omdch1 == 0).Count();
                            int countBad = cnt201 + cnt202; ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;

                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count();
                            int omd0 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 0 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count();
                            int omw1 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 1 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count();
                            int omw0 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 0 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count();
                            int omm1 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 1 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count();
                            int omm0 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 0 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count();
                            int omq1 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 1 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count();
                            int omq0 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 0 && list1.Contains(s.divID) && (s.wchk == 2 || s.wchk == 3)).Count();
                            List<uhspageitemsDb> pageModel = new List<uhspageitemsDb>(); uhspageitemsDb List1 = new uhspageitemsDb();
                        ...
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID)).Count(); ViewBag.countTotal = countTotal;
                            int countGood = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && list1.Contains(s.divID) && s.omdch1 == 1 && s.omdch2 == 1 && s.omdch3 == 1).Count();
                            ViewBag.countGood = countGood;
                            int countBad = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && list1.Contains(s.divID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0)).Count();
                        ...
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID)).Count(); ViewBag.countTotal = countTotal;
                            int cnt101 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 2 && list1.Contains(s.divID) && s.omdch1 == 1 && s.omdch2 == 1).Count();
                            int cnt102 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 3 && list1.Contains(s.divID) && s.omdch1 == 1).Count();
                            int countGood = cnt101 + cnt102; ViewBag.countGood = countGood;
                            int cnt201 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 2 && list1.Contains(s.divID) && (s.omdch1 == 0 || s.omdch2 == 0)).Count();
                            int cnt202 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 3 && list1.Contains(s.divID) && s.omdch1 == 0).Count();
                            int countBad = cnt201 + cnt202; ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                    ...
                    if (dych1 == 5)
                    {
                        ...
                        List<int> list1 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 2).Select(s => s.divID).Distinct());
                        ViewBag.division = new SelectList(opb.dimDivisionDbs.Where(s => s.ID == 0 || list1.Contains(s.ID)).OrderBy(s => s.DivisionName), "ID", "DivisionName").ToList();

                        if (dt1 == chk4 && chk4c > chk4b && chk4b > chk4)
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID)).Count(); ViewBag.countTotal = countTotal;
                            int cnt101 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 1 && list1.Contains(s.divID) && s.omdch1 == 1 && s.omdch2 == 1 && s.omdch3 == 1 && s.omdch4 == 1).Count();
                            int cnt102 = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && list1.Contains(s.divID) && s.omdch1 == 1).Count();
                            int countGood = cnt101 + cnt102; ViewBag.countGood = countGood;
                            int cnt201 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 1 && list1.Contains(s.divID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0 || s.omdch4 == 0)).Count();
                            int cnt202 = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && list1.Contains(s.divID) && s.omdch1 == 0).Count();
                            int countBad = cnt201 + cnt202; ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && list1.Contains(s.divID)).Count();
                            int omd0 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 0 && list1.Contains(s.divID)).Count();
                            int omw1 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 1 && list1.Contains(s.divID)).Count();
                            int omw0 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 0 && list1.Contains(s.divID)).Count();
                            int omm1 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 1 && list1.Contains(s.divID)).Count();
                            int omm0 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 0 && list1.Contains(s.divID)).Count();
                            int omq1 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 1 && list1.Contains(s.divID)).Count();
                            int omq0 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 0 && list1.Contains(s.divID)).Count();
                            List<uhspageitemsDb> pageModel = new List<uhspageitemsDb>(); uhspageitemsDb List1 = new uhspageitemsDb();
                        ...
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID)).Count(); ViewBag.countTotal = countTotal;
                            int cnt101 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 1 && list1.Contains(s.divID) && s.omdch1 == 1 && s.omdch2 == 1 && s.omdch3 == 1).Count();
                            int cnt102 = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && list1.Contains(s.divID) && s.omdch1 == 1 && s.omdch2 == 1).Count();
                            int countGood = cnt101 + cnt102; ViewBag.countGood = countGood;
                            int cnt201 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 1 && list1.Contains(s.divID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0)).Count();
                            int cnt202 = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && list1.Contains(s.divID) && (s.omdch1 == 0 || s.omdch2 == 0)).Count();
                            int countBad = cnt201 + cnt202; ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && list1.Contains(s.divID)).Count();
                        ...
                        if (dt1 == chk3 && chk3b > chk3)
                        {
                            ...
                            int countGood = cnt101 + cnt102; ViewBag.countGood = countGood;
                            int cnt201 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 2 && list1.Contains(s.divID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0)).Count();
                            int cnt202 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 3 && list1.Contains(s.divID) && (s.omdch1 == 0 || s.omdch2 == 0)).Count();
                            int countBad = cnt201 + cnt202; ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && list1.Contains(s.divID)).Count();
                        ...
                        if (dt1 == chk2)
                        {
                            ...
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID)).Count(); ViewBag.countTotal = countTotal;
                            int cnt101 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 1 && list1.Contains(s.divID) && s.omdch1 == 1 && s.omdch2 == 1).Count();
                            int cnt102 = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && list1.Contains(s.divID) && s.omdch1 == 1).Count();
                            int countGood = cnt101 + cnt102; ViewBag.countGood = countGood;
                            int cnt201 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 1 && list1.Contains(s.divID) && (s.omdch1 == 0 || s.omdch2 == 0)).Count();
                            int cnt202 = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && list1.Contains(s.divID) && s.omdch1 == 0).Count();
                            int countBad = cnt201 + cnt202; ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                    ...
                    else
                    {
                        ...
                        int countTotal = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID) && s.omdch1 == 1).Count();
                        ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID) && s.omdch1 == 0).Count();
                        ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && list1.Contains(s.divID)).Count();
                ...
                {
                    int lisa01 = db.agentsDbs.Where(s => s.agentID == agentid).Select(s => s.divid).First();                    
                    List<int> lista01 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 2 && s.divID == lisa01).Select(s => s.ID).Distinct());
                    ViewBag.headdef1 = opb.dimDivisionDbs.Where(s => s.ID == lisa01).Select(s => s.DivisionName).First();
                    ...
                    if (dych1 == 7)
                    {
                        ...
                        List<int> list1 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 2 && s.wchk == 3 && lista01.Contains(s.ID)).Select(s => s.divID).Distinct());
                        ViewBag.division = new SelectList(opb.dimDivisionDbs.Where(s => s.ID == 0 || list1.Contains(s.ID)).OrderBy(s => s.DivisionName), "ID", "DivisionName").ToList();
                        if (dt1 == chk4)
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID)).Count(); ViewBag.countTotal = countTotal;
                    ...
                    if (dych1 == 6)
                    {
                        ...
                        List<int> list1 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 2 && (s.wchk == 2 || s.wchk == 3) && lista01.Contains(s.ID)).Select(s => s.divID).Distinct());
                        ViewBag.division = new SelectList(opb.dimDivisionDbs.Where(s => s.ID == 0 || list1.Contains(s.ID)).OrderBy(s => s.DivisionName), "ID", "DivisionName").ToList();
                    ...
                    if (dych1 == 5)
                    {
                        ...
                        List<int> list1 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 2 && lista01.Contains(s.ID)).Select(s => s.divID).Distinct());
                        ViewBag.division = new SelectList(opb.dimDivisionDbs.Where(s => s.ID == 0 || list1.Contains(s.ID)).OrderBy(s => s.DivisionName), "ID", "DivisionName").ToList();
                        ...
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID)).Count(); ViewBag.countTotal = countTotal;
                            int countGood = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID) && s.omdch1 == 1 && s.omdch2 == 1 && s.omdch3 == 1).Count();
                            ViewBag.countGood = countGood;
                            int countBad = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.divID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0)).Count();
                            ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && list1.Contains(s.divID)).Count();
                ...
                {
                    List<int> lista01 = new List<int>(opb.UHSUSAC1SURSERVDbs.Where(s => s.MGRID == agentid).Select(s => s.DISTID).Distinct());
                    ...
                    if (dych1 == 7)
                    {
                        ...
                        List<int> list1 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 2 && s.wchk == 3 && lista01.Contains(s.ID)).Select(s => s.divID).Distinct());
                        List<int> lista04 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 2 && s.wchk == 3 && s.OMDID == userid).Select(s => s.ID).Distinct());
                        ViewBag.division = new SelectList(opb.dimDivisionDbs.Where(s => s.ID == 0 || list1.Contains(s.ID)).OrderBy(s => s.DivisionName), "ID", "DivisionName").ToList();

                        if (dt1 == chk4)
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => lista04.Contains(s.ID)).Count(); ViewBag.countTotal = countTotal;
                            int countGood = opb.UHSWEBAACvDbs.Where(s => lista04.Contains(s.ID) && s.omdch1 == 1 && s.omdch2 == 1 && s.omdch3 == 1 && s.omdch4 == 1).Count(); ViewBag.countGood = countGood;
                            int countBad = opb.UHSWEBAACvDbs.Where(s => lista04.Contains(s.ID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0 || s.omdch4 == 0)).Count(); ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && lista04.Contains(s.ID)).Count(); int omd0 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 0 && lista04.Contains(s.ID)).Count(); int omw1 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 1 && lista04.Contains(s.ID)).Count(); int omw0 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 0 && lista04.Contains(s.ID)).Count(); int omm1 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 1 && lista04.Contains(s.ID)).Count(); int omm0 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 0 && lista04.Contains(s.ID)).Count(); int omq1 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 1 && lista04.Contains(s.ID)).Count(); int omq0 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 0 && lista04.Contains(s.ID)).Count();
                            List<uhspageitemsDb> pageModel = new List<uhspageitemsDb>(); uhspageitemsDb List1 = new uhspageitemsDb();
                        ...
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => lista04.Contains(s.ID)).Count(); ViewBag.countTotal = countTotal;
                            int countGood = opb.UHSWEBAACvDbs.Where(s => lista04.Contains(s.ID) && s.omdch1 == 1 && s.omdch2 == 1 && s.omdch3 == 1).Count(); ViewBag.countGood = countGood;
                            int countBad = opb.UHSWEBAACvDbs.Where(s => lista04.Contains(s.ID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0)).Count(); ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && lista04.Contains(s.ID)).Count(); int omd0 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 0 && lista04.Contains(s.ID)).Count(); int omw1 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 1 && lista04.Contains(s.ID)).Count(); int omw0 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 0 && lista04.Contains(s.ID)).Count(); int omm1 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 1 && lista04.Contains(s.ID)).Count(); int omm0 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 0 && lista04.Contains(s.ID)).Count(); int omq1 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 1 && lista04.Contains(s.ID)).Count(); int omq0 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 0 && lista04.Contains(s.ID)).Count();
                            List<uhspageitemsDb> pageModel = new List<uhspageitemsDb>(); uhspageitemsDb List1 = new uhspageitemsDb();
                        ...
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => lista04.Contains(s.ID)).Count(); ViewBag.countTotal = countTotal;
                            int countGood = opb.UHSWEBAACvDbs.Where(s => lista04.Contains(s.ID) && s.omdch1 == 1 && s.omdch2 == 1).Count(); ViewBag.countGood = countGood;
                            int countBad = opb.UHSWEBAACvDbs.Where(s => lista04.Contains(s.ID) && (s.omdch1 == 0 || s.omdch2 == 0)).Count(); ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && lista04.Contains(s.ID)).Count(); int omd0 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 0 && lista04.Contains(s.ID)).Count(); int omw1 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 1 && lista04.Contains(s.ID)).Count(); int omw0 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 0 && lista04.Contains(s.ID)).Count(); int omm1 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 1 && lista04.Contains(s.ID)).Count(); int omm0 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 0 && lista04.Contains(s.ID)).Count(); int omq1 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 1 && lista04.Contains(s.ID)).Count(); int omq0 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 0 && lista04.Contains(s.ID)).Count();
                            List<uhspageitemsDb> pageModel = new List<uhspageitemsDb>(); uhspageitemsDb List1 = new uhspageitemsDb();
                        ...
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => lista04.Contains(s.ID)).Count(); ViewBag.countTotal = countTotal;
                            int countGood = opb.UHSWEBAACvDbs.Where(s => lista04.Contains(s.ID) && s.omdch1 == 1).Count(); ViewBag.countGood = countGood;
                            int countBad = opb.UHSWEBAACvDbs.Where(s => lista04.Contains(s.ID) && (s.omdch1 == 0)).Count(); ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && lista04.Contains(s.ID)).Count(); int omd0 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 0 && lista04.Contains(s.ID)).Count(); int omw1 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 1 && lista04.Contains(s.ID)).Count(); int omw0 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 0 && lista04.Contains(s.ID)).Count(); int omm1 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 1 && lista04.Contains(s.ID)).Count(); int omm0 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 0 && lista04.Contains(s.ID)).Count(); int omq1 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 1 && lista04.Contains(s.ID)).Count(); int omq0 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 0 && lista04.Contains(s.ID)).Count();
                            List<uhspageitemsDb> pageModel = new List<uhspageitemsDb>(); uhspageitemsDb List1 = new uhspageitemsDb();
                    ...
                    if (dych1 == 6)
                    {
                        ...
                        List<int> list1 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 2 && (s.wchk == 2 || s.wchk == 3) && lista01.Contains(s.ID)).Select(s => s.divID).Distinct());
                        List<int> lista05 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 2 && (s.wchk == 2 || s.wchk == 3) && s.OMDID == userid).Select(s => s.ID).Distinct());
                        ViewBag.division = new SelectList(opb.dimDivisionDbs.Where(s => s.ID == 0 || list1.Contains(s.ID)).OrderBy(s => s.DivisionName), "ID", "DivisionName").ToList();

                        if (dt1 == chk4 && chk4b > chk4)
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => lista05.Contains(s.ID)).Count(); ViewBag.countTotal = countTotal; int cnt101 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 2 && lista05.Contains(s.ID) && s.omdch1 == 1 && s.omdch2 == 1 && s.omdch3 == 1 && s.omdch4 == 1).Count(); int cnt102 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 3 && lista05.Contains(s.ID) && s.omdch1 == 1).Count(); int countGood = cnt101 + cnt102; ViewBag.countGood = countGood; int cnt201 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 2 && lista05.Contains(s.ID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0 || s.omdch4 == 0)).Count(); int cnt202 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 3 && lista05.Contains(s.ID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0)).Count(); int countBad = cnt201 + cnt202; ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && lista05.Contains(s.ID)).Count(); int omd0 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 0 && lista05.Contains(s.ID)).Count(); int omw1 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 1 && lista05.Contains(s.ID)).Count(); int omw0 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 0 && lista05.Contains(s.ID)).Count(); int omm1 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 1 && lista05.Contains(s.ID)).Count(); int omm0 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 0 && lista05.Contains(s.ID)).Count(); int omq1 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 1 && lista05.Contains(s.ID)).Count(); int omq0 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 0 && lista05.Contains(s.ID)).Count();
                            List<uhspageitemsDb> pageModel = new List<uhspageitemsDb>(); uhspageitemsDb List1 = new uhspageitemsDb();
                            List1.modInt01 = omd1; List1.modInt02 = omd0; List1.modInt03 = omw1; List1.modInt04 = omw0; List1.modInt05 = omm1; List1.modInt06 = omm0; List1.modInt07 = omq1; List1.modInt08 = omq0;
                            pageModel.Add(List1);
                        ...
                        if (dt1 == chk4 && chk4b <= chk4)
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => lista05.Contains(s.ID)).Count(); ViewBag.countTotal = countTotal;
                            int countGood = opb.UHSWEBAACvDbs.Where(s => lista05.Contains(s.ID) && s.omdch1 == 1 && s.omdch2 == 1 && s.omdch3 == 1 && s.omdch4 == 1).Count();
                            ViewBag.countGood = countGood;
                            int countBad = opb.UHSWEBAACvDbs.Where(s => lista05.Contains(s.ID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0 || s.omdch4 == 0)).Count(); ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && lista05.Contains(s.ID)).Count(); int omd0 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 0 && lista05.Contains(s.ID)).Count(); int omw1 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 1 && lista05.Contains(s.ID)).Count(); int omw0 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 0 && lista05.Contains(s.ID)).Count(); int omm1 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 1 && lista05.Contains(s.ID)).Count(); int omm0 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 0 && lista05.Contains(s.ID)).Count(); int omq1 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 1 && lista05.Contains(s.ID)).Count(); int omq0 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 0 && lista05.Contains(s.ID)).Count();
                            List<uhspageitemsDb> pageModel = new List<uhspageitemsDb>(); uhspageitemsDb List1 = new uhspageitemsDb();
                        ...
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => lista05.Contains(s.ID)).Count(); ViewBag.countTotal = countTotal;
                            int cnt101 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 2 && lista05.Contains(s.ID) && s.omdch1 == 1 && s.omdch2 == 1 && s.omdch3 == 1).Count();
                            int cnt102 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 3 && lista05.Contains(s.ID) && s.omdch1 == 1).Count();
                            int countGood = cnt101 + cnt102; ViewBag.countGood = countGood;
                            int cnt201 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 2 && lista05.Contains(s.ID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0)).Count();
                            int cnt202 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 3 && lista05.Contains(s.ID) && s.omdch1 == 0).Count();
                            int countBad = cnt201 + cnt202; ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && lista05.Contains(s.ID)).Count();
                            int omd0 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 0 && lista05.Contains(s.ID)).Count();
                            int omw1 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 1 && lista05.Contains(s.ID)).Count();
                            int omw0 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 0 && lista05.Contains(s.ID)).Count();
                            int omm1 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 1 && lista05.Contains(s.ID)).Count();
                            int omm0 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 0 && lista05.Contains(s.ID)).Count();
                            int omq1 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 1 && lista05.Contains(s.ID)).Count();
                            int omq0 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 0 && lista05.Contains(s.ID)).Count();
                            List<uhspageitemsDb> pageModel = new List<uhspageitemsDb>(); uhspageitemsDb List1 = new uhspageitemsDb();
                        ...
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => lista05.Contains(s.ID)).Count(); ViewBag.countTotal = countTotal;
                            int countGood = opb.UHSWEBAACvDbs.Where(s => lista05.Contains(s.ID) && s.omdch1 == 1 && s.omdch2 == 1 && s.omdch3 == 1).Count();
                            ViewBag.countGood = countGood;
                            int countBad = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && list1.Contains(s.divID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0)).Count();
                            ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        ...
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => lista05.Contains(s.ID)).Count(); ViewBag.countTotal = countTotal;
                            int cnt101 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 2 && lista05.Contains(s.ID) && s.omdch1 == 1 && s.omdch2 == 1).Count();
                            int cnt102 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 3 && lista05.Contains(s.ID) && s.omdch1 == 1).Count();
                            int countGood = cnt101 + cnt102; ViewBag.countGood = countGood;
                            int cnt201 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 2 && lista05.Contains(s.ID) && (s.omdch1 == 0 || s.omdch2 == 0)).Count();
                            int cnt202 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 3 && lista05.Contains(s.ID) && s.omdch1 == 0).Count();
                            int countBad = cnt201 + cnt202; ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                    ...
                    if (dych1 == 5)
                    {
                        ...
                        List<int> list1 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 2 && lista01.Contains(s.ID)).Select(s => s.divID).Distinct());
                        List<int> lista06 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 2 && s.OMDID == userid).Select(s => s.ID).Distinct());
                        ViewBag.division = new SelectList(opb.dimDivisionDbs.Where(s => s.ID == 0 || list1.Contains(s.ID)).OrderBy(s => s.DivisionName), "ID", "DivisionName").ToList();

                        if (dt1 == chk4 && chk4c > chk4b && chk4b > chk4)
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => lista06.Contains(s.ID)).Count(); ViewBag.countTotal = countTotal;
                            int cnt101 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 1 && lista06.Contains(s.ID) && s.omdch1 == 1 && s.omdch2 == 1 && s.omdch3 == 1 && s.omdch4 == 1).Count();
                            int cnt102 = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && lista06.Contains(s.ID) && s.omdch1 == 1).Count();
                            int countGood = cnt101 + cnt102; ViewBag.countGood = countGood;
                            int cnt201 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 1 && lista06.Contains(s.ID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0 || s.omdch4 == 0)).Count();
                            int cnt202 = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && lista06.Contains(s.ID) && s.omdch1 == 0).Count();
                            int countBad = cnt201 + cnt202; ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && lista06.Contains(s.ID)).Count();
                            int omd0 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 0 && lista06.Contains(s.ID)).Count();
                            int omw1 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 1 && lista06.Contains(s.ID)).Count();
                            int omw0 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 0 && lista06.Contains(s.ID)).Count();
                            int omm1 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 1 && lista06.Contains(s.ID)).Count();
                            int omm0 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 0 && lista06.Contains(s.ID)).Count();
                            int omq1 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 1 && lista06.Contains(s.ID)).Count();
                            int omq0 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 0 && lista06.Contains(s.ID)).Count();
                            List<uhspageitemsDb> pageModel = new List<uhspageitemsDb>(); uhspageitemsDb List1 = new uhspageitemsDb();
                        ...
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => lista06.Contains(s.ID)).Count(); ViewBag.countTotal = countTotal;
                            int cnt101 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 1 && lista06.Contains(s.ID) && s.omdch1 == 1 && s.omdch2 == 1 && s.omdch3 == 1).Count();
                            int cnt102 = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && lista06.Contains(s.ID) && s.omdch1 == 1 && s.omdch2 == 1).Count();
                            int countGood = cnt101 + cnt102; ViewBag.countGood = countGood;
                            int cnt201 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 1 && lista06.Contains(s.ID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0)).Count();
                            int cnt202 = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && lista06.Contains(s.ID) && (s.omdch1 == 0 || s.omdch2 == 0)).Count();
                            int countBad = cnt201 + cnt202; ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && lista06.Contains(s.ID)).Count();
                        ...
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => lista06.Contains(s.ID)).Count(); ViewBag.countTotal = countTotal;
                            int countGood = opb.UHSWEBAACvDbs.Where(s => lista06.Contains(s.ID) && s.omdch1 == 1 && s.omdch2 == 1 && s.omdch3 == 1).Count(); ViewBag.countGood = countGood;
                            int countBad = opb.UHSWEBAACvDbs.Where(s => lista06.Contains(s.ID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0)).Count(); ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && lista06.Contains(s.ID)).Count();
                            int omd0 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 0 && lista06.Contains(s.ID)).Count();
                        ...
                        if (dt1 == chk3 && chk3b > chk3)
                        {
                            ...
                            int cnt102 = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && lista06.Contains(s.ID) && s.omdch1 == 1 && s.omdch2 == 1).Count();
                            int countGood = cnt101 + cnt102; ViewBag.countGood = countGood;
                            int cnt201 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 2 && lista06.Contains(s.ID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0)).Count();
                            int cnt202 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 3 && lista06.Contains(s.ID) && (s.omdch1 == 0 || s.omdch2 == 0)).Count();
                            int countBad = cnt201 + cnt202; ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && lista06.Contains(s.ID)).Count();
                        ...
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => lista06.Contains(s.ID)).Count(); ViewBag.countTotal = countTotal;
                            int countGood = opb.UHSWEBAACvDbs.Where(s => lista06.Contains(s.ID) && s.omdch1 == 1 && s.omdch2 == 1 && s.omdch3 == 1).Count();
                            ViewBag.countGood = countGood;
                            int countBad = opb.UHSWEBAACvDbs.Where(s => lista06.Contains(s.ID) && (s.omdch1 == 0 || s.omdch2 == 0 || s.omdch3 == 0)).Count();
                            ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                            int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && lista06.Contains(s.ID)).Count();
                        ...
                        {
                            int countTotal = opb.UHSWEBAACvDbs.Where(s => lista06.Contains(s.ID)).Count(); ViewBag.countTotal = countTotal;
                            int cnt101 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 1 && lista06.Contains(s.ID) && s.omdch1 == 1 && s.omdch2 == 1).Count();
                            int cnt102 = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && lista06.Contains(s.ID) && s.omdch1 == 1).Count();
                            int countGood = cnt101 + cnt102; ViewBag.countGood = countGood;
                            int cnt201 = opb.UHSWEBAACvDbs.Where(s => s.wchk == 1 && lista06.Contains(s.ID) && (s.omdch1 == 0 || s.omdch2 == 0)).Count();
                            int cnt202 = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && lista06.Contains(s.ID) && s.omdch1 == 0).Count();
                            int countBad = cnt201 + cnt202; ViewBag.countBad = countBad;
                            var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                            var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                    ...
                    {
                        List<int> list1 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 2 && lista01.Contains(s.ID)).Select(s => s.divID).Distinct());
                        List<int> lista07 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 2 && s.OMDID == userid).Select(s => s.ID).Distinct());
                        ViewBag.division = new SelectList(opb.dimDivisionDbs.Where(s => s.ID == 0 || list1.Contains(s.ID)).OrderBy(s => s.DivisionName), "ID", "DivisionName").ToList();

                        int countTotal = opb.UHSWEBAACvDbs.Where(s => lista07.Contains(s.ID)).Count(); ViewBag.countTotal = countTotal;
                        int countGood = opb.UHSWEBAACvDbs.Where(s => lista07.Contains(s.ID) && s.omdch1 == 1).Count();
                        ViewBag.countGood = countGood;
                        int countBad = opb.UHSWEBAACvDbs.Where(s => lista07.Contains(s.ID) && s.omdch1 == 0).Count();
                        ViewBag.countBad = countBad;
                        var cntperc = string.Format("{0:n2}", ((float)(int)countGood / (float)(int)countTotal) * 100); ViewBag.cntperc = cntperc;
                        var cntperc2 = string.Format("{0:n2}", ((float)(int)countBad / (float)(int)countTotal) * 100); ViewBag.cntperc2 = cntperc2;
                        int omd1 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 1 && lista07.Contains(s.ID)).Count();
                        int omd0 = opb.UHSWEBAACvDbs.Where(s => s.omdch1 == 0 && lista07.Contains(s.ID)).Count();
                        int omw1 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 1 && lista07.Contains(s.ID)).Count();
                        int omw0 = opb.UHSWEBAACvDbs.Where(s => s.omdch2 == 0 && lista07.Contains(s.ID)).Count();
                        int omm1 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 1 && lista07.Contains(s.ID)).Count();
                        int omm0 = opb.UHSWEBAACvDbs.Where(s => s.omdch3 == 0 && lista07.Contains(s.ID)).Count();
                        int omq1 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 1 && lista07.Contains(s.ID)).Count();
                        int omq0 = opb.UHSWEBAACvDbs.Where(s => s.omdch4 == 0 && lista07.Contains(s.ID)).Count();
                        List<uhspageitemsDb> pageModel = new List<uhspageitemsDb>(); uhspageitemsDb List1 = new uhspageitemsDb();
        ...
        public ActionResult _bck1010009()
        {
            string CurrentLoginID = User.Identity.GetUserId().ToString();
                                                                                ...
                                                                                && returnTaskOrdersIDlist.Contains(57)))
            {
                ...
                if (userTypeid == 2)
                {
                    List<int> list1 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 2).Select(s => s.ID).Distinct());
                    var itemdt = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010009 && s.tspdid == 1 && list1.Contains(s.distid) && s.yyyymmdd >= l2week)
                    ...
                    return PartialView("_bck1010009", data.ToList());

                }
                else if (usertitle == 1)
                {
                    int list1 = db.agentsDbs.Where(s => s.ID == userid).Select(s => s.divid).First();

                    
                    List<int> list3 = new List<int>(opa.DISTRICTSDbs.Where(s => s.divID == list1).Select(s => s.ID).Distinct().ToList());

                    var itemdt = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010009 && s.tspdid == 1 && list3.Contains(s.distid) && s.yyyymmdd >= l2week)
                                                .Select(s => new { ID = s.ID, crdate = s.crdate, yyyymm = s.yyyymm, weeknr = s.weeknr, dctpid = s.dctpid, distid = s.distid, distnm = s.distnm });
                    List<UHSOMD11vDb> data = new List<UHSOMD11vDb>();
                    foreach (var item in itemdt)
                    {
                ...
                {
                    List<int> list1 = new List<int>(opb.UHSUSAC1SURSERVDbs.Where(s => s.MGRID == userid).Select(s => s.DISTID).Distinct().ToList());
                    List<int> list2 = new List<int>(opa.DISTRICTSDbs.Where(s => s.compid == 2 && list1.Contains(s.ID)).Select(s => s.ID).Distinct());

                    var itemdt = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010009 && s.tspdid == 1 && list2.Contains(s.distid) && s.yyyymmdd >= l2week)
                                                .Select(s => new { ID = s.ID, crdate = s.crdate, yyyymm = s.yyyymm, weeknr = s.weeknr, dctpid = s.dctpid, distid = s.distid, distnm = s.distnm });
                    List<UHSOMD11vDb> data = new List<UHSOMD11vDb>();
                    foreach (var item in itemdt)
                    {
            ...
            return PartialView("_bck1010009");
        }

        public ActionResult getEditPar1010009(int dctp, int id1, int id2, string id3)
        {
                                                                                ...
                                                                                && cnt1 >= 1))
            {
                ...
                var yer = DateTime.Now.ToString("yyyy");
                var yer1 = int.Parse(yer);
                var dtbr1 = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010009 && s.tspdid == 1 && s.distid == id1).OrderByDescending(s => s.crdate).Select(s => s.crdate).First();
                ...
                if (id2 == 1)
                {
                    var wchk1 = opa.DISTRICTSDbs.Where(s => s.ID == id1 && s.compid == 2).Select(s => s.wchk).First();
                    ...
                    List<UHSOMD11vDb> UHSOMD11vDbA = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010009 && s.tspdid == 1 && s.distid == id1 && s.crdate == dtbr1).ToList();
                    var a11 = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010009 && s.tspdid == 1 && s.distid == id1 && s.crdate == dtbr1).Select(s => s.ID).First();
                    ...
                    List<UHSOMD11vDb> UHSOMD11vDbB = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010009 && s.tspdid == 2 && s.distid == id1 && s.yyyymm == per1 && s.weeknr == wek1).ToList();
                    var a12 = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010009 && s.tspdid == 2 && s.distid == id1 && s.yyyymm == per1 && s.weeknr == wek1).Select(s => s.ID).First();
                    ...
                    List<UHSOMD11vDb> UHSOMD11vDbC = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010009 && s.tspdid == 3 && s.distid == id1 && s.yyyymm == per2).ToList();
                    var a13 = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010009 && s.tspdid == 3 && s.distid == id1 && s.yyyymm == per2).Select(s => s.ID).First();
                    ...
                    List<UHSOMD11vDb> UHSOMD11vDbD = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010009 && s.tspdid == 4 && s.distid == id1 && qtrdates.Contains(s.crdate)).ToList();
                    var a14 = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010009 && s.tspdid == 4 && s.distid == id1 && qtrdates.Contains(s.crdate)).Select(s => s.ID).First();
                    ...
                    var id329 = UHSOMD13Db.Select(s => s.smid129).First();
                    ...
                    List1.CZsmid129 = db.agentsDbs.Where(s => s.ID == id329).Select(s => s.agentName).First();
                    ...
                    List1.CZcmdt129 = UHSOMD13Db.Select(s => s.cmdt129).First();
                    ...
                    List1.zacc = opa.DISTRICTSDbs.Where(s => s.compid == 2 && s.ID == id1).Select(s => s.district).First();
                    List1.zdiv = opa.DISTRICTSDbs.Where(s => s.compid == 2 && s.ID == id1).Select(s => s.divisionName).First();
                    List1.zomh = opa.DISTRICTSDbs.Where(s => s.compid == 2 && s.ID == id1).Select(s => s.OMD).First();
                    List1.zdod = opa.DISTRICTSDbs.Where(s => s.compid == 2 && s.ID == id1).Select(s => s.DOD).First();
                    ...
                    return View("getEditPar1010009", pageModel);
                }
                else
                if (id2 == 2)
                {
                    ...
                    List<UHSOMD11vDb> UHSOMD11vDbA = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010009 && s.tspdid == 1 && s.distid == id1 && s.crdate == datr01).ToList();
                    ...
                    List<UHSOMD11vDb> UHSOMD11vDbB = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010009 && s.tspdid == 2 && s.distid == id1 && s.yyyy == year01 && s.weeknr == week01).ToList();
                    var a12 = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010009 && s.tspdid == 2 && s.distid == id1 && s.yyyy == year01 && s.weeknr == week01).Select(s => s.ID).First();
                    List<UHSOMD12Db> UHSOMD12Db = opa.UHSOMD12Dbs.Where(s => s.ID == a12).ToList();
                    ...
                    List<UHSOMD11vDb> UHSOMD11vDbC = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010009 && s.tspdid == 3 && s.distid == id1 && s.yyyymm == mnth02).ToList();
                    var a13 = opb.UHSOMD11vDbs.Where(s => s.dctpid == 1010009 && s.tspdid == 3 && s.distid == id1 && s.yyyymm == mnth02).Select(s => s.ID).First();
                    List<UHSOMD13Db> UHSOMD13Db = opa.UHSOMD13Dbs.Where(s => s.ID == a13).ToList();
        ...
        public ActionResult _getSurgicaldata(int IDa, int IDb)
        {
            string CurrentLoginID = User.Identity.GetUserId().ToString();
            ...
            if (IDa == 0 && IDb == 0)
            {
                if (userTypeid == 2)
                {
                    var datatable = opb.UHSWEBAACvDbs.OrderBy(s => s.ID).ToList();
                    return PartialView("_getSurgicaldata", datatable);
                }
                else if (usertitle == 1)
                {
                    int list1 = db.agentsDbs.Where(s => s.ID == userid).Select(s => s.divid).First();                  
                    var datatable = opb.UHSWEBAACvDbs.Where(s => s.divID == list1).OrderBy(s => s.ID).ToList();
                    return PartialView("_getSurgicaldata", datatable);
                }
                else if (usertitle == 2 || usertitle == 3)
                {
                    var list1 = opb.UHSUSAC1SURSERVDbs.Where(s => s.MGRID == userid).Select(s => s.DISTID).Distinct().ToList();   
                    var datatable = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.ID)).OrderBy(s => s.ID).ToList();
                    return PartialView("_getSurgicaldata", datatable);
                }
                else
                {
            ...
            else if (IDa != 0 && IDb == 0)
            {
                if (userTypeid == 2)
                {
                    var datatable = opb.UHSWEBAACvDbs.Where(s => s.divID == IDa).OrderBy(s => s.ID).ToList();
                    return PartialView("_getSurgicaldata", datatable);
                }
                else if (usertitle == 1)
                {
                    var list1 = db.agentsDbs.Where(s => s.ID == userid).Select(s => s.divid).First();
                    var datatable = opb.UHSWEBAACvDbs.Where(s => s.divID == IDa && s.divID == list1).OrderBy(s => s.ID).ToList();
                    return PartialView("_getSurgicaldata", datatable);
                }
                else if (usertitle == 2 || usertitle == 3)
                {
            ...
            else if (IDb != 0)
            {
                if (userTypeid == 2)
                {
                    var datatable = opb.UHSWEBAACvDbs.Where(s => s.ID == IDb).OrderBy(s => s.ID).ToList();
                    return PartialView("_getSurgicaldata", datatable);
                }
                else if (usertitle == 1)
                {
                    var list1 = db.agentsDbs.Where(s => s.ID == userid).Select(s => s.divid).First();
                    var datatable = opb.UHSWEBAACvDbs.Where(s => s.ID == IDb && s.divID == list1).OrderBy(s => s.ID).ToList();
                    return PartialView("_getSurgicaldata", datatable);
                }
                else if (usertitle == 2 || usertitle == 3)
                {
                    var list1 = opb.UHSUSAC1SURSERVDbs.Where(s => s.MGRID == userid).Select(s => s.DISTID).Distinct().ToList();
                    var datatable = opb.UHSWEBAACvDbs.Where(s => s.ID == IDb && list1.Contains(s.ID)).OrderBy(s => s.ID).ToList();
                    return PartialView("_getSurgicaldata", datatable);
                }
                else
                {
        ...
        public ActionResult getssdist(int ID)
        {
            string CurrentLoginID = User.Identity.GetUserId().ToString();
            ...
            if (userTypeid == 2)
            {
                var datatable = opa.DISTRICTSDbs.Where(s => s.ID == 0 || (s.divID == ID && s.compid == 2)).OrderBy(s => s.ID).Select(s => new { ID = s.ID, district = s.district }).ToList();
            ...
            {
                var list1 = opb.UHSUSAC1SURSERVDbs.Where(s => s.MGRID == userid).Select(s => s.DISTID).Distinct().ToList();
                var datatable = opa.DISTRICTSDbs.Where(s => s.ID == 0 || (s.divID == ID && list1.Contains(s.ID))).OrderBy(s => s.ID).Select(s => new { ID = s.ID, district = s.district }).ToList();
                return Json(datatable, JsonRequestBehavior.AllowGet);
            }
            else
            {
        ...
        public ActionResult getSurgicalmap()
        {
            string CurrentLoginID = User.Identity.GetUserId().ToString();
            ...
            if (dych1 == 7)
            {
                if (userTypeid == 2)
                {
                    var datatable = opb.UHSWEBAACvDbs.Where(s => s.wchk == 3).ToList();
                    return Json(datatable, JsonRequestBehavior.AllowGet);
                }
                else if (usertitle == 1)
                {
                    var list1 = db.agentsDbs.Where(s => s.ID == userid).Select(s => s.divid).First();
                    var list2 = opa.DISTRICTSDbs.Where(s => s.compid == 2 && s.divID == list1).Select(s => s.ID).Distinct().ToList();
                    var datatable = opb.UHSWEBAACvDbs.Where(s => s.wchk == 3 && list2.Contains(s.divID)).ToList();
                    return Json(datatable, JsonRequestBehavior.AllowGet);
                }
                else if (usertitle == 2 || usertitle == 3)
                {
                    var list1 = opb.UHSUSAC1SURSERVDbs.Where(s => s.MGRID == userid).Select(s => s.DISTID).Distinct().ToList();
                    var datatable = opb.UHSWEBAACvDbs.Where(s => s.wchk == 3 && list1.Contains(s.ID)).ToList();
                    return Json(datatable, JsonRequestBehavior.AllowGet);
                }
                else
                {
                    var list2 = opa.DISTRICTSDbs.Where(s => s.compid == 2 && s.OMDID == userid).Select(s => s.ID).Distinct().ToList();
                    var datatable = opb.UHSWEBAACvDbs.Where(s => s.wchk == 3 && list2.Contains(s.ID)).ToList();
                    return Json(datatable, JsonRequestBehavior.AllowGet);
                }
            }
            else if (dych1 == 6 || dych1 == 7)
            {
                if (userTypeid == 2)
                {
                    var datatable = opb.UHSWEBAACvDbs.Where(s => s.wchk == 2 || s.wchk == 3).ToList();
                    return Json(datatable, JsonRequestBehavior.AllowGet);
                }
                else if (userTypeid == 3 && usertitle == 1)
                {
                    var list1 = db.agentsDbs.Where(s => s.ID == userid).Select(s => s.divid).First();
                    var list2 = opa.DISTRICTSDbs.Where(s => s.compid == 2 && s.divID == list1).Select(s => s.ID).Distinct().ToList();
                    var datatable = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && list2.Contains(s.ID)).ToList();
                    return Json(datatable, JsonRequestBehavior.AllowGet);
                }
                else if (userTypeid == 3 && (usertitle == 2 || usertitle == 3))
                {
                    var list1 = opb.UHSUSAC1SURSERVDbs.Where(s => s.MGRID == userid).Select(s => s.DISTID).Distinct().ToList();
                    var datatable = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && list1.Contains(s.ID)).ToList();
                    return Json(datatable, JsonRequestBehavior.AllowGet);
                }
                else
                {
                    var list3 = opa.DISTRICTSDbs.Where(s => s.compid == 2 && s.OMDID == userid).Select(s => s.ID).Distinct().ToList();
                    var datatable = opb.UHSWEBAACvDbs.Where(s => (s.wchk == 2 || s.wchk == 3) && list3.Contains(s.ID)).ToList();
                    return Json(datatable, JsonRequestBehavior.AllowGet);
                }
            }
            else
            {
                ...
                if (usertitle == 1)
                {
                    var list1 = db.agentsDbs.Where(s => s.ID == userid).Select(s => s.divid).First();
                    var list2 = opa.DISTRICTSDbs.Where(s => s.compid == 2 && s.divID == list1).Select(s => s.ID).Distinct().ToList();
                    var datatable = opb.UHSWEBAACvDbs.Where(s => list2.Contains(s.ID)).ToList();
                    return Json(datatable, JsonRequestBehavior.AllowGet);
                }
                else if (usertitle == 2 || usertitle == 3)
                {
                    var list1 = opb.UHSUSAC1SURSERVDbs.Where(s => s.MGRID == userid).Select(s => s.DISTID).Distinct().ToList();
                    var datatable = opb.UHSWEBAACvDbs.Where(s => list1.Contains(s.ID)).ToList();
                    return Json(datatable, JsonRequestBehavior.AllowGet);
                }
                else
                {
                    var list4 = opa.DISTRICTSDbs.Where(s => s.compid == 2 && s.OMDID == userid).Select(s => s.ID).Distinct().ToList();
                    var datatable = opb.UHSWEBAACvDbs.Where(s => list4.Contains(s.ID)).ToList();
                    return Json(datatable, JsonRequestBehavior.AllowGet);
                }
            }
